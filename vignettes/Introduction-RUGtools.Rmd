...
properties when dividing **n** pizzas among **p** guests. Smaller pieces allow 
guests to more precisely estimate personal pizza consumption, thus decreasing the integer-programming problem exacerbated by larger slices. Thus, _if_ one requests the 
_**party cut**_, the `pizza_estimate` shall be more accurate. This reduces wasted 
pizza and exhibiting great stewardship of sponsor resources bestowed upon thee.
